...
def ServiceInfoListEntry(a, b, valueType=TYPE_TEXT, param=4):
	...
	return [
		...
		(eListboxPythonMultiContent.TYPE_TEXT, 0, 0, 320, 35, 0, RT_HALIGN_LEFT, ""),
		(eListboxPythonMultiContent.TYPE_TEXT, 0, 0, 320, 35, 0, RT_HALIGN_LEFT, a),
		(eListboxPythonMultiContent.TYPE_TEXT, 330, 0, 570, 35, 0, RT_HALIGN_LEFT, b)
	]
